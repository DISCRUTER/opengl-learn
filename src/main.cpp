...
int main() {
    ...
    // generating and binding texture1
    ...
    unsigned char* data = stbi_load("resources/images/profile.png", &width, &height, &nrChannels, 4);
    if (data) {
...
void processInput(GLFWwindow* window) {
    ...
    const float cameraSpeed = 2.5f * deltaTime; // move speed
